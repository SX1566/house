...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "831qEDx6aGuyXsL2MRXZsbRZDmhLJuZIt0vvmlBO";
    private static final String SECRET_KEY = "uPoudE0MIaraic1e9zk4Bu9rT2FkubmoZuL_5ojB";

    // 要上传的空间
    private static final String bucketname = "sx1566";
